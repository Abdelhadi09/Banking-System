...
public class airline_reservation {
    ...
    public static void main(String[] args) {
        System.out.println("Welcome to ABDELHADI Airlines");
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:// reserve seat
                    ...
                    break;
                case 3:
                    System.out.println("Thank you for using ABDELHADI Airlines");
                    System.exit(0);
            } // end of switch case
        } // end of while loop
    } // end of main method
    ...
    public static void reserveSeat() {
        ...
        int seat = sc.nextInt();
        // if checks if the seat is avaliable or not and if the the seat is avaliable it
        // reserves the seat
